...
This mechanism has been integrated into Bitcore-Node-Hashtalt which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/hashtaltpay/insight-api-hashtalt#web-socket-api](https://github.com/hashtaltpay/insight-api-hashtalt#web-socket-api)
* API: [https://github.com/hashtaltpay/insight-api-hashtalt#instantsend-transactions](https://github.com/hashtaltpay/insight-api-hashtalt#instantsend-transactions)
...
By default, the Hashtalt Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Hashtalt Core daemon:
