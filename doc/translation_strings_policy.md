...
This document provides guidelines for internationalization of the Hashtalt Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `hashtalt_en.ts` remains unchanged.
