...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid hashtalt address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid hashtalt address" in e.error['message'])
