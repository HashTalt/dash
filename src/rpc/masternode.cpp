...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Hashtalt address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "hashtalt",               "masternode",             &masternode,             true,  {} },
    { "hashtalt",               "masternodelist",         &masternodelist,         true,  {} },
    { "hashtalt",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "hashtalt",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "hashtalt",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "hashtalt",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
