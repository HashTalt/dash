...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in hashtalt.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("hashtalt.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Hashtalt features */
    { "hashtalt",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "hashtalt",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "hashtalt",               "gobject",                &gobject,                true,  {} },
    { "hashtalt",               "voteraw",                &voteraw,                true,  {} },
