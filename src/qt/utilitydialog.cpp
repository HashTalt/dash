    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  hashtalt-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Hashtalt in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 HASHTALT, 0.1 HASHTALT, 1 HASHTALT and 10 HASHTALT -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://hashtaltpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://hashtaltpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
