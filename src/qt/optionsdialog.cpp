    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("HASHTALT-light"), QVariant("light"));
    ui->theme->addItem(QString("HASHTALT-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("HASHTALT-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("HASHTALT-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("HASHTALT-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("HASHTALT-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("HASHTALT-traditional"), QVariant("trad"));
