...
BOOST_AUTO_TEST_CASE(rpc_format_monetary_values)
{
    ...
    BOOST_CHECK(ValueFromAmount(2098879887988790LL).write() == "20988799.98879990");
    BOOST_CHECK(ValueFromAmount(2098879887988799LL).write() == "20988799.98879887");
...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("20988799.9887999")), 2098879887988790LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("20988799.98879887")), 2098879887988799LL);
